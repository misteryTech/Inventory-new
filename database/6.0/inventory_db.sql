...
-- ----------------------------
INSERT INTO `inventory` VALUES (4, '222-123', 'mouse', 'it produxts', 1081, 132.00, 'wow', NULL, NULL, NULL, NULL, '0', NULL);
INSERT INTO `inventory` VALUES (5, '222', '123', 'asd', 123, 1123.00, '', NULL, NULL, NULL, NULL, '0', NULL);
INSERT INTO `inventory` VALUES (15, '12345', 'barcode', 'Electronics', 190, 2500.00, '4', 'qrcodes/12345.png', 'Available', 'New', NULL, '0', NULL);
INSERT INTO `inventory` VALUES (22, '1724065019001', 'Laptop', 'Lab Equipment', 1, 160000.00, '7', 'qrcodes/1724065019001.png', 'Available', 'New', '2024-10-25', '0', NULL);
INSERT INTO `inventory` VALUES (23, 'HQ61280138336002991', 'Printer/ EPSON', 'Lab Equipment', -1, 90000.00, '8', 'qrcodes/HQ61280138336002991.png', '', '', '2024-10-25', '0', NULL);
INSERT INTO `inventory` VALUES (24, '4800049720121', 'Nature spring', 'Stationery', 1, 10.00, '7', 'qrcodes/4800049720121.png', 'Available', 'Used', '2024-10-25', '0', NULL);
...
-- ----------------------------
-- Table structure for releases_table
-- ----------------------------
DROP TABLE IF EXISTS `releases_table`;
CREATE TABLE `releases_table`  (
  `release_id` int NOT NULL AUTO_INCREMENT,
  `request_id` int NOT NULL,
  `item_code` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `quantity_released` int NOT NULL,
  `release_date` timestamp NOT NULL DEFAULT current_timestamp,
  `release_notes` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`release_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of releases_table
-- ----------------------------
INSERT INTO `releases_table` VALUES (1, 9, '1724065019001', 2, '2024-11-12 14:44:22', NULL);
INSERT INTO `releases_table` VALUES (2, 15, 'HQ61280138336002991', 2, '2024-11-12 14:45:52', NULL);
INSERT INTO `releases_table` VALUES (3, 20, '4', 23333, '2024-11-12 14:46:42', NULL);
INSERT INTO `releases_table` VALUES (4, 6, '222-123', 10, '2024-11-12 14:48:32', NULL);
INSERT INTO `releases_table` VALUES (5, 6, '12345', 10, '2024-11-12 14:48:32', NULL);
...
INSERT INTO `request_items_table` VALUES (23, 18, '4', 1);
INSERT INTO `request_items_table` VALUES (24, 19, '4', 2);
INSERT INTO `request_items_table` VALUES (25, 20, '4', 23333);
INSERT INTO `request_items_table` VALUES (26, 21, '222', 2);
...
-- ----------------------------
INSERT INTO `requests_table` VALUES (6, '211', 'for multi media', '2024-10-25 07:47:19', 'Released', NULL);
...
INSERT INTO `requests_table` VALUES (9, 'admin', 'for library', '2024-10-25 13:58:32', 'Released', NULL);
...
INSERT INTO `requests_table` VALUES (15, 'admin', 'kulang gamit', '2024-10-25 16:32:23', 'Released', NULL);
...
INSERT INTO `requests_table` VALUES (18, 'sample1', 'for library', '2024-11-11 23:11:11', 'Pending', NULL);
INSERT INTO `requests_table` VALUES (19, 'sample1', 'for library', '2024-11-11 23:14:00', 'Pending', '219384');
INSERT INTO `requests_table` VALUES (20, 'sample1', 'for reymark', '2024-11-11 23:34:01', 'Released', '869272');
INSERT INTO `requests_table` VALUES (21, 'sample1', 'for library', '2024-11-11 23:35:18', 'Pending', '168843');
